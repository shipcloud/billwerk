...
describe Billwerk::Client do
  ...
  describe "when making requests" do
    ...
    it "uses the production endpoint when production is set to true" do
      client = Billwerk::Client.new(production: true)
    ...
    it "sets a default user agent" do
      client = Billwerk::Client.new(bearer_token: 'bt')
      request = stub_get("/").
        with(headers: { user_agent: Billwerk::Default.user_agent })
    ...
    it "accepts a custom user agent" do
      ...
      client = Billwerk::Client.new(user_agent: user_agent, bearer_token: 'bt')
    ...
    it 'creates the correct auth headers with supplied bearer_token' do
      ...
      client = Billwerk::Client.new(bearer_token: token)
  ...
  context "error handling" do
    it "raises on 404" do
      ...
      expect { client.get('/four_oh_four') }.to raise_error Billwerk::NotFound
    end
    ...
    it "raises on 500" do
      ...
      expect { client.get('/five_oh_oh') }.to raise_error Billwerk::InternalServerError
    end
    ...
    it "raises a ClientError on unknown client errors" do
      ...
      expect { client.get('/something') }.to raise_error Billwerk::ClientError
    end
    ...
    it "raises a ServerError on unknown server errors" do
      ...
      expect { client.get('/something') }.to raise_error Billwerk::ServerError
    end
  end
